...
import { resolveSnap, resolveResizeSnap } from '@/features/artboard/lib/snap-resolver';
import { getMinSize, getMaxSize, getAspectRatio } from '@/shared/lib/component-sizes';
